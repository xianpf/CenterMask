    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        if iteration % 20 == 0 or iteration == max_iter:
            logger.info(
                ...
                ("\n# of instances: level 0: {}\t|level 1: {}\t|level 2: {}\t|"+\
                "level 3: {}\t|level 4: {}\t|level 5: {} | # of instances counts: {}").format(
                model.log_dict['pyr_num_l0'], 
                model.log_dict['pyr_num_l1'], 
                model.log_dict['pyr_num_l2'], 
                model.log_dict['pyr_num_l3'], 0, 0, 
                model.log_dict['InstPyr_inst_count'])
            )
            # logger.info(("# of instances: level 0: {}\t|level 1: {}\t|level 2: {}\t|"+\
            #     "level 3: {}\t|level 4: {}\t|level 5: {} | # of instances counts: {}").format(
            #     model.log_dict['pyr_num_l0'], model.log_dict['pyr_num_l0'], model.log_dict['pyr_num_l1'], 
...
# v23 masked class loss, logits are masked
...
def main():
    ...
    cfg.merge_from_list(['OUTPUT_DIR', 'run/scratch_v23_maskclass'])
